...
1. **Lane E1 — split shell-level sections from operator-level pane policy.** Keep document, preset, playback, and export actions as shell-level concerns rather than the long-term operator pane model.
