...
8. **Preset workflow (PARTIAL).**
	...
	Remaining gap: preview-only extras still live in preview-local modules, and the chosen document scene family still does not change renderer or parameter-surface behavior yet.
