...
8. **Preset workflow (PARTIAL).**
	...
	Remaining gap: preview-only extras still live in preview-local modules, and the shared document `project` metadata for scene family and targets is not surfaced in the UI yet.
